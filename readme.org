...
Read the [[https://raw.githubusercontent.com/NightMachinery/LibraGrad/master/paper/LibraGrad_v2.4.5_with_appendices.pdf][paper]]. Appendix C of the paper contains many multi-object qualitative examples.
